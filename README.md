...
| Cask | Description |
|---|---|
| [`openstats`](Casks/openstats.rb) | Menu bar system monitor — CPU, GPU, memory, network, disk, battery and temperatures, with fan control, keep-awake and cleanup. |
...
OpenStats and QuotaBar require macOS 14 (Sonoma) or later; CLIState and LiteMD
require macOS 15 (Sequoia) or later. All of them are signed with a Developer ID
certificate and notarized by Apple. OpenStats ships separate Apple silicon and
Intel builds; the cask picks the right one.
